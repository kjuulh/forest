...
/// Generated client implementations.
pub mod o_auth_apps_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct OAuthAppsServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl OAuthAppsServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> OAuthAppsServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> OAuthAppsServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            OAuthAppsServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn create_o_auth_app(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateOAuthAppRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateOAuthAppResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/CreateOAuthApp",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("forest.v1.OAuthAppsService", "CreateOAuthApp"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_o_auth_apps(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOAuthAppsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListOAuthAppsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/ListOAuthApps",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("forest.v1.OAuthAppsService", "ListOAuthApps"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_o_auth_app(
            &mut self,
            request: impl tonic::IntoRequest<super::GetOAuthAppRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetOAuthAppResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/GetOAuthApp",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("forest.v1.OAuthAppsService", "GetOAuthApp"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn update_o_auth_app(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateOAuthAppRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateOAuthAppResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/UpdateOAuthApp",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("forest.v1.OAuthAppsService", "UpdateOAuthApp"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn rotate_o_auth_app_secret(
            &mut self,
            request: impl tonic::IntoRequest<super::RotateOAuthAppSecretRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RotateOAuthAppSecretResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/RotateOAuthAppSecret",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OAuthAppsService", "RotateOAuthAppSecret"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete_o_auth_app(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteOAuthAppRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeleteOAuthAppResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/DeleteOAuthApp",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("forest.v1.OAuthAppsService", "DeleteOAuthApp"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn lookup_o_auth_client(
            &mut self,
            request: impl tonic::IntoRequest<super::LookupOAuthClientRequest>,
        ) -> std::result::Result<
            tonic::Response<super::LookupOAuthClientResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/LookupOAuthClient",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OAuthAppsService", "LookupOAuthClient"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn create_o_auth_authorization_code(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateOAuthAuthorizationCodeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateOAuthAuthorizationCodeResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/CreateOAuthAuthorizationCode",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn exchange_o_auth_code(
            &mut self,
            request: impl tonic::IntoRequest<super::ExchangeOAuthCodeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ExchangeOAuthCodeResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/ExchangeOAuthCode",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OAuthAppsService", "ExchangeOAuthCode"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_o_auth_userinfo(
            &mut self,
            request: impl tonic::IntoRequest<super::GetOAuthUserinfoRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/GetOAuthUserinfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OAuthAppsService", "GetOAuthUserinfo"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn refresh_o_auth_token(
            ...
            tonic::Response<super::RefreshOAuthTokenResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/RefreshOAuthToken",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OAuthAppsService", "RefreshOAuthToken"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn revoke_o_auth_grant(
            &mut self,
            request: impl tonic::IntoRequest<super::RevokeOAuthGrantRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RevokeOAuthGrantResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/RevokeOAuthGrant",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OAuthAppsService", "RevokeOAuthGrant"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_o_auth_grants(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOAuthGrantsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListOAuthGrantsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/ListOAuthGrants",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OAuthAppsService", "ListOAuthGrants"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_o_auth_consent(
            &mut self,
            request: impl tonic::IntoRequest<super::GetOAuthConsentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetOAuthConsentResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OAuthAppsService/GetOAuthConsent",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OAuthAppsService", "GetOAuthConsent"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
/// Generated server implementations.
pub mod o_auth_apps_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with OAuthAppsServiceServer.
    #[async_trait]
    pub trait OAuthAppsService: std::marker::Send + std::marker::Sync + 'static {
        async fn create_o_auth_app(
            &self,
            request: tonic::Request<super::CreateOAuthAppRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateOAuthAppResponse>,
            tonic::Status,
        >;
        async fn list_o_auth_apps(
            &self,
            request: tonic::Request<super::ListOAuthAppsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListOAuthAppsResponse>,
            tonic::Status,
        >;
        async fn get_o_auth_app(
            &self,
            request: tonic::Request<super::GetOAuthAppRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetOAuthAppResponse>,
            tonic::Status,
        >;
        async fn update_o_auth_app(
            &self,
            request: tonic::Request<super::UpdateOAuthAppRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateOAuthAppResponse>,
            tonic::Status,
        >;
        async fn rotate_o_auth_app_secret(
            &self,
            request: tonic::Request<super::RotateOAuthAppSecretRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RotateOAuthAppSecretResponse>,
            tonic::Status,
        >;
        async fn delete_o_auth_app(
            &self,
            request: tonic::Request<super::DeleteOAuthAppRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeleteOAuthAppResponse>,
            tonic::Status,
        >;
        async fn lookup_o_auth_client(
            &self,
            request: tonic::Request<super::LookupOAuthClientRequest>,
        ) -> std::result::Result<
            tonic::Response<super::LookupOAuthClientResponse>,
            tonic::Status,
        >;
        async fn create_o_auth_authorization_code(
            &self,
            request: tonic::Request<super::CreateOAuthAuthorizationCodeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateOAuthAuthorizationCodeResponse>,
            tonic::Status,
        >;
        async fn exchange_o_auth_code(
            &self,
            request: tonic::Request<super::ExchangeOAuthCodeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ExchangeOAuthCodeResponse>,
            tonic::Status,
        >;
        ...
        async fn refresh_o_auth_token(
            &self,
            request: tonic::Request<super::RefreshOAuthTokenRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RefreshOAuthTokenResponse>,
            tonic::Status,
        >;
        async fn revoke_o_auth_grant(
            &self,
            request: tonic::Request<super::RevokeOAuthGrantRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RevokeOAuthGrantResponse>,
            tonic::Status,
        >;
        async fn list_o_auth_grants(
            &self,
            request: tonic::Request<super::ListOAuthGrantsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListOAuthGrantsResponse>,
            tonic::Status,
        >;
        async fn get_o_auth_consent(
            &self,
            request: tonic::Request<super::GetOAuthConsentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetOAuthConsentResponse>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct OAuthAppsServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> OAuthAppsServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for OAuthAppsServiceServer<T>
    where
        T: OAuthAppsService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/forest.v1.OAuthAppsService/CreateOAuthApp" => {
                    #[allow(non_camel_case_types)]
                    struct CreateOAuthAppSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::CreateOAuthAppRequest>
                    for CreateOAuthAppSvc<T> {
                        type Response = super::CreateOAuthAppResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::create_o_auth_app(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateOAuthAppSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/ListOAuthApps" => {
                    #[allow(non_camel_case_types)]
                    struct ListOAuthAppsSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::ListOAuthAppsRequest>
                    for ListOAuthAppsSvc<T> {
                        type Response = super::ListOAuthAppsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::list_o_auth_apps(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListOAuthAppsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/GetOAuthApp" => {
                    #[allow(non_camel_case_types)]
                    struct GetOAuthAppSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::GetOAuthAppRequest>
                    for GetOAuthAppSvc<T> {
                        type Response = super::GetOAuthAppResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::get_o_auth_app(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetOAuthAppSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/UpdateOAuthApp" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateOAuthAppSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::UpdateOAuthAppRequest>
                    for UpdateOAuthAppSvc<T> {
                        type Response = super::UpdateOAuthAppResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::update_o_auth_app(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateOAuthAppSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/RotateOAuthAppSecret" => {
                    #[allow(non_camel_case_types)]
                    struct RotateOAuthAppSecretSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::RotateOAuthAppSecretRequest>
                    for RotateOAuthAppSecretSvc<T> {
                        type Response = super::RotateOAuthAppSecretResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::rotate_o_auth_app_secret(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RotateOAuthAppSecretSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/DeleteOAuthApp" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteOAuthAppSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::DeleteOAuthAppRequest>
                    for DeleteOAuthAppSvc<T> {
                        type Response = super::DeleteOAuthAppResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::delete_o_auth_app(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteOAuthAppSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/LookupOAuthClient" => {
                    #[allow(non_camel_case_types)]
                    struct LookupOAuthClientSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::LookupOAuthClientRequest>
                    for LookupOAuthClientSvc<T> {
                        type Response = super::LookupOAuthClientResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::lookup_o_auth_client(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = LookupOAuthClientSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/CreateOAuthAuthorizationCode" => {
                    #[allow(non_camel_case_types)]
                    struct CreateOAuthAuthorizationCodeSvc<T: OAuthAppsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<
                        super::CreateOAuthAuthorizationCodeRequest,
                    > for CreateOAuthAuthorizationCodeSvc<T> {
                        type Response = super::CreateOAuthAuthorizationCodeResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::create_o_auth_authorization_code(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateOAuthAuthorizationCodeSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/ExchangeOAuthCode" => {
                    #[allow(non_camel_case_types)]
                    struct ExchangeOAuthCodeSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::ExchangeOAuthCodeRequest>
                    for ExchangeOAuthCodeSvc<T> {
                        type Response = super::ExchangeOAuthCodeResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::exchange_o_auth_code(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ExchangeOAuthCodeSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/GetOAuthUserinfo" => {
                    #[allow(non_camel_case_types)]
                    struct GetOAuthUserinfoSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::GetOAuthUserinfoRequest>
                    for GetOAuthUserinfoSvc<T> {
                        type Response = super::GetOAuthUserinfoResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::get_o_auth_userinfo(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/forest.v1.OAuthAppsService/RefreshOAuthToken" => {
                    #[allow(non_camel_case_types)]
                    struct RefreshOAuthTokenSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::RefreshOAuthTokenRequest>
                    for RefreshOAuthTokenSvc<T> {
                        type Response = super::RefreshOAuthTokenResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::refresh_o_auth_token(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RefreshOAuthTokenSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/RevokeOAuthGrant" => {
                    #[allow(non_camel_case_types)]
                    struct RevokeOAuthGrantSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::RevokeOAuthGrantRequest>
                    for RevokeOAuthGrantSvc<T> {
                        type Response = super::RevokeOAuthGrantResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::revoke_o_auth_grant(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RevokeOAuthGrantSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/ListOAuthGrants" => {
                    #[allow(non_camel_case_types)]
                    struct ListOAuthGrantsSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::ListOAuthGrantsRequest>
                    for ListOAuthGrantsSvc<T> {
                        type Response = super::ListOAuthGrantsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::list_o_auth_grants(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListOAuthGrantsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OAuthAppsService/GetOAuthConsent" => {
                    #[allow(non_camel_case_types)]
                    struct GetOAuthConsentSvc<T: OAuthAppsService>(pub Arc<T>);
                    impl<
                        T: OAuthAppsService,
                    > tonic::server::UnaryService<super::GetOAuthConsentRequest>
                    for GetOAuthConsentSvc<T> {
                        type Response = super::GetOAuthConsentResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OAuthAppsService>::get_o_auth_consent(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetOAuthConsentSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for OAuthAppsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "forest.v1.OAuthAppsService";
    impl<T> tonic::server::NamedService for OAuthAppsServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
/// Generated client implementations.
pub mod org_rule_set_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    ///
    #[derive(Debug, Clone)]
    pub struct OrgRuleSetServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl OrgRuleSetServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> OrgRuleSetServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> OrgRuleSetServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            OrgRuleSetServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        ///
        pub async fn create_org_rule_set(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateOrgRuleSetRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateOrgRuleSetResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OrgRuleSetService/CreateOrgRuleSet",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OrgRuleSetService", "CreateOrgRuleSet"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn update_org_rule_set(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateOrgRuleSetRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateOrgRuleSetResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OrgRuleSetService/UpdateOrgRuleSet",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OrgRuleSetService", "UpdateOrgRuleSet"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn delete_org_rule_set(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteOrgRuleSetRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeleteOrgRuleSetResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OrgRuleSetService/DeleteOrgRuleSet",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OrgRuleSetService", "DeleteOrgRuleSet"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn list_org_rule_sets(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOrgRuleSetsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListOrgRuleSetsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.OrgRuleSetService/ListOrgRuleSets",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("forest.v1.OrgRuleSetService", "ListOrgRuleSets"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
/// Generated server implementations.
pub mod org_rule_set_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with OrgRuleSetServiceServer.
    #[async_trait]
    pub trait OrgRuleSetService: std::marker::Send + std::marker::Sync + 'static {
        ///
        async fn create_org_rule_set(
            &self,
            request: tonic::Request<super::CreateOrgRuleSetRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateOrgRuleSetResponse>,
            tonic::Status,
        >;
        ...
        async fn update_org_rule_set(
            &self,
            request: tonic::Request<super::UpdateOrgRuleSetRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateOrgRuleSetResponse>,
            tonic::Status,
        >;
        ...
        async fn delete_org_rule_set(
            &self,
            request: tonic::Request<super::DeleteOrgRuleSetRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeleteOrgRuleSetResponse>,
            tonic::Status,
        >;
        ...
        async fn list_org_rule_sets(
            &self,
            request: tonic::Request<super::ListOrgRuleSetsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListOrgRuleSetsResponse>,
            tonic::Status,
        >;
    ...
    ///
    #[derive(Debug)]
    pub struct OrgRuleSetServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> OrgRuleSetServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for OrgRuleSetServiceServer<T>
    where
        T: OrgRuleSetService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/forest.v1.OrgRuleSetService/CreateOrgRuleSet" => {
                    #[allow(non_camel_case_types)]
                    struct CreateOrgRuleSetSvc<T: OrgRuleSetService>(pub Arc<T>);
                    impl<
                        T: OrgRuleSetService,
                    > tonic::server::UnaryService<super::CreateOrgRuleSetRequest>
                    for CreateOrgRuleSetSvc<T> {
                        type Response = super::CreateOrgRuleSetResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OrgRuleSetService>::create_org_rule_set(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateOrgRuleSetSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OrgRuleSetService/UpdateOrgRuleSet" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateOrgRuleSetSvc<T: OrgRuleSetService>(pub Arc<T>);
                    impl<
                        T: OrgRuleSetService,
                    > tonic::server::UnaryService<super::UpdateOrgRuleSetRequest>
                    for UpdateOrgRuleSetSvc<T> {
                        type Response = super::UpdateOrgRuleSetResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OrgRuleSetService>::update_org_rule_set(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateOrgRuleSetSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OrgRuleSetService/DeleteOrgRuleSet" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteOrgRuleSetSvc<T: OrgRuleSetService>(pub Arc<T>);
                    impl<
                        T: OrgRuleSetService,
                    > tonic::server::UnaryService<super::DeleteOrgRuleSetRequest>
                    for DeleteOrgRuleSetSvc<T> {
                        type Response = super::DeleteOrgRuleSetResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OrgRuleSetService>::delete_org_rule_set(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteOrgRuleSetSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.OrgRuleSetService/ListOrgRuleSets" => {
                    #[allow(non_camel_case_types)]
                    struct ListOrgRuleSetsSvc<T: OrgRuleSetService>(pub Arc<T>);
                    impl<
                        T: OrgRuleSetService,
                    > tonic::server::UnaryService<super::ListOrgRuleSetsRequest>
                    for ListOrgRuleSetsSvc<T> {
                        type Response = super::ListOrgRuleSetsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OrgRuleSetService>::list_org_rule_sets(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListOrgRuleSetsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for OrgRuleSetServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "forest.v1.OrgRuleSetService";
    impl<T> tonic::server::NamedService for OrgRuleSetServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod registry_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn search_public_components(
            &mut self,
            request: impl tonic::IntoRequest<super::SearchPublicComponentsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SearchPublicComponentsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "forest.v1.RegistryService",
                        "SearchPublicComponents",
                    ),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_public_component_detail(
            &mut self,
            request: impl tonic::IntoRequest<super::GetPublicComponentDetailRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetPublicComponentDetailResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "forest.v1.RegistryService",
                        "GetPublicComponentDetail",
                    ),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_public_component_manifest(
            &mut self,
            request: impl tonic::IntoRequest<super::GetPublicComponentManifestRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetPublicComponentManifestResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod registry_service_server {
    ...
    pub trait RegistryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn search_public_components(
            &self,
            request: tonic::Request<super::SearchPublicComponentsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SearchPublicComponentsResponse>,
            tonic::Status,
        >;
        async fn get_public_component_detail(
            &self,
            request: tonic::Request<super::GetPublicComponentDetailRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetPublicComponentDetailResponse>,
            tonic::Status,
        >;
        async fn get_public_component_manifest(
            &self,
            request: tonic::Request<super::GetPublicComponentManifestRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetPublicComponentManifestResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/forest.v1.RegistryService/SearchPublicComponents" => {
                    #[allow(non_camel_case_types)]
                    struct SearchPublicComponentsSvc<T: RegistryService>(pub Arc<T>);
                    impl<
                        T: RegistryService,
                    > tonic::server::UnaryService<super::SearchPublicComponentsRequest>
                    for SearchPublicComponentsSvc<T> {
                        type Response = super::SearchPublicComponentsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RegistryService>::search_public_components(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SearchPublicComponentsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.RegistryService/GetPublicComponentDetail" => {
                    #[allow(non_camel_case_types)]
                    struct GetPublicComponentDetailSvc<T: RegistryService>(pub Arc<T>);
                    impl<
                        T: RegistryService,
                    > tonic::server::UnaryService<super::GetPublicComponentDetailRequest>
                    for GetPublicComponentDetailSvc<T> {
                        type Response = super::GetPublicComponentDetailResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::GetPublicComponentDetailRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RegistryService>::get_public_component_detail(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetPublicComponentDetailSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/forest.v1.RegistryService/GetPublicComponentManifest" => {
                    #[allow(non_camel_case_types)]
                    struct GetPublicComponentManifestSvc<T: RegistryService>(pub Arc<T>);
                    impl<
                        T: RegistryService,
                    > tonic::server::UnaryService<
                        super::GetPublicComponentManifestRequest,
                    > for GetPublicComponentManifestSvc<T> {
                        type Response = super::GetPublicComponentManifestResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RegistryService>::get_public_component_manifest(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetPublicComponentManifestSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
...
pub mod signal_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn report_signal(
            &mut self,
            request: impl tonic::IntoRequest<super::ReportSignalRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReportSignalResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.SignalService/ReportSignal",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("forest.v1.SignalService", "ReportSignal"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/forest.v1.SignalService/ListSignals",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("forest.v1.SignalService", "ListSignals"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod signal_service_server {
    ...
    pub trait SignalService: std::marker::Send + std::marker::Sync + 'static {
        async fn report_signal(
            &self,
            request: tonic::Request<super::ReportSignalRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReportSignalResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/forest.v1.SignalService/ReportSignal" => {
                    #[allow(non_camel_case_types)]
                    struct ReportSignalSvc<T: SignalService>(pub Arc<T>);
                    impl<
                        T: SignalService,
                    > tonic::server::UnaryService<super::ReportSignalRequest>
                    for ReportSignalSvc<T> {
                        type Response = super::ReportSignalResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SignalService>::report_signal(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReportSignalSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "forest.v1.SignalService";
