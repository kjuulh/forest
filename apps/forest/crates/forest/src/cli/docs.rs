...
fn print_commands() {
    ...
    println!();
    println!("        Auto-runs codegen if forest.component.cue is newer than forestgen.ts.");
    println!("        This means `forest build` is the only command needed after spec changes.");
    println!();
